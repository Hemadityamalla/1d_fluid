...
order1 = log2(norm(dx.data(:,field) - dx_2.data(1:2:end,field),Inf)/norm(dx_2.data(:,field) - dx_4.data(1:2:end,field),Inf))

order2 = log2(norm(dx_2.data(:,field) - dx_4.data(1:2:end,field),Inf)/norm(dx_4.data(:,field) - dx_8.data(1:2:end,field),Inf))